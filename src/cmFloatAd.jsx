      ...
      <div style={contentStyle}>
        ...
        {isMobile && isHovered ? (
          <div style={textContentStyle}>
            <span>&copy; {currentYear} Adam Clement and Simon Rundell, Dept of ITDD</span>
            <span>Exeter College, Hele Road, Exeter EX4 4JS.</span>
            <span>Tel: 01392 400500</span>
          </div>
        ) : !isMobile ? (
          <span>
            &nbsp;&copy; {currentYear} Adam Clement and Simon Rundell, Dept of ITDD, Exeter College, Hele Road, Exeter EX4 4JS. | Tel: 01392 400500
          </span>
        ) : null}
      </div>
    </div>
